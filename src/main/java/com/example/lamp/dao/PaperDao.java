...
public interface PaperDao {
    int createpaper(@Param("title")String title,
                    @Param("guidename")String guidename,
                    @Param("prayname")String prayname,
                    @Param("respname")String respname,
                    @Param("offername")String offername,
                    @Param("ccm1")String ccm1,
                    ...
                    @Param("notice1")String notice1,
                    @Param("notice2")String notice2,
                    @Param("notice3")String notice3,
                    @Param("speachname")String speachname,
                    @Param("nprayname")String nprayname,
                    @Param("nrespname")String nrespname,
                    @Param("noffername")String noffername); // 주보 생성
